...
/**
 * @file
 * Day and night theme's implementation to display a single Drupal page.
 *
...
<div id="page">
  ...
  <header id="header" role="banner">
    ...
    <?php
      $top_first  = render($page['top_first']);
      $top_second = render($page['top_second']);
    ?>

    <?php if ($top_first || $top_second): ?>
      <section id="top">
        <?php print $top_first; ?>
    ...
    <section id="navigation">
      <div class="table">
        <div class="row">
          ...
          <?php if ($main_menu || $site_name || $site_slogan): ?>
  ...
  <footer id="footer" role="contentinfo">
    ...
    <?php
      $bottom_first  = render($page['bottom_first']);
      $bottom_second = render($page['bottom_second']);
    ?>

    <?php if ($bottom_first || $bottom_second): ?>
      <section id="bottom">
